...
Watch this video to learn the approach and what types of problems benefit from this technique.

Apply that same approach to solve this problem.
...
Before understanding heap sort, watch this video to first learn the concept of a heap.

Now to see a practical application of heap, let's learn about heap sort.

Watch this video first to get an overview of the technique.
